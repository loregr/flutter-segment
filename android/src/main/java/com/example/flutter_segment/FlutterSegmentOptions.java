...
public class FlutterSegmentOptions {
    ...
    public Boolean getTrackDeepLinks() {
    ...
    static FlutterSegmentOptions create(Bundle bundle) {
        ...
        Boolean trackDeepLinks = bundle.getBoolean("com.claimsforce.segment.TRACK_DEEP_LINKS", false);
        ...
        return new FlutterSegmentOptions(writeKey, trackDeepLinks, trackApplicationLifecycleEvents, isAmplitudeIntegrationEnabled, isAppsflyerIntegrationEnabled, debug);
    }
    ...
    static FlutterSegmentOptions create(HashMap<String, Object> options) {
        ...
        Boolean trackDeepLinks = orFalse((Boolean) options.get("trackDeepLinks"));
